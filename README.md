...
|1️⃣1️⃣|[Find_the_Fibonacci_Number](https://github.com/JakubStachh/C-Simple-Projects/tree/main/C%20-%20Projects%20Simple/projects/Find_the_Fibonacci_Number)|Uses a loop to avoid recursion, Updates two previous values to generate the next one|
...
|2️⃣0️⃣|[Swap_Two_Numbers_Without_a_Temporary_Variable](https://github.com/JakubStachh/C-Simple-Projects/tree/main/C%2B%2B%20Projects/projects/Swap_Two_Numbers_Without_a_Temporary_Variable)|This C++ program demonstrates how to swap the values of two variables without using a temporary variable|
...
#### You can use [Programiz Complier](https://www.programiz.com/c-programming/online-compiler/) or similar online compliers to run the code
...
- and then run:
  ...
  **For C++**:
  ...
  ```
  ##
- For C# You will have to check if you got [`.NET SDK`](https://dotnet.microsoft.com/en-us/download/dotnet) installed:
  ```
  dotnet --version
  ```
